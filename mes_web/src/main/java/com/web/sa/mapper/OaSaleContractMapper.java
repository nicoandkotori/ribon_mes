...
public interface OaSaleContractMapper  extends BaseMapper<OaSaleContract> {
    ...
    List<OaSaleContract> getListBySync(@Param("main") OaSaleContract mainDTO, @Param("database") String database,@Param("izError")Integer izError);
    List<OaSaleContract> getListBySyncEdit(@Param("main") OaSaleContract mainDTO, @Param("database") String database,@Param("izError")Integer izError);
