layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    tableSelect.prototype.render = function (opt) {
        ...
        elem.off('click').on('click', function(e) {
            ...
            var lastHeight = $(window).height() - elem.offset().top -  elem.outerHeight() - 72;

            var t = elem.offset().top + elem.outerHeight()+"px";
            if(opt.table.height > lastHeight){
                t = elem.offset().top - opt.table.height - 72 +"px";
            }
            ...
            //overHeight && tableBox.css({'top':'0px','bottom':'auto'});
