...
layui.define(['jquery', 'form', 'layer', 'element'], function(exports) {
	...
	/*
	    ...
	    flagFull  是否最大化
	*/
	window.WeAdminShow = function(title, url,flagFull, w, h) {
		if(flagFull == null || flagFull == undefined){
			flagFull = false;
		}
		if(flagFull !=null && flagFull !=true){
			flagFull = false;
		}
		if(title == null || title == '') {
			title = false;
	...
	/*
	    ...
	    flagFull  是否最大化
	*/
	window.openComponent = function(title, url, param,w, h,flagFull) {
		if(flagFull == null || flagFull == undefined){
			flagFull = false;
		}
		if(flagFull !=null && flagFull !=true){
	...
	window.WeAdminShow1 = function(title, url,flagFull, w, h) {
		if(flagFull == null || flagFull == undefined){
			flagFull = false;
		}
		if(flagFull !=null && flagFull !=true){
	...
	window.WeAdminShow2 = function(title, url,flagFull, w, h) {
		if(flagFull == null || flagFull == undefined){
			flagFull = false;
		}
		if(flagFull !=null && flagFull !=true){
	...
	window.WeAdminShow3 = function(title, url,flagFull, w, h) {
		if(flagFull == null || flagFull == undefined){
			flagFull = false;
		}
		if(flagFull !=null && flagFull !=true){
	...
	/*弹出层+传递ID参数*/
	window.WeAdminEdit = function(title, url,flagFull, id, w, h) {
		if(flagFull == null || flagFull == undefined){
			flagFull = false;
		}
		if(title == null || title == '') {
